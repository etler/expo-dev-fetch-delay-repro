...
function withAndroidReactNativeSSEPatch(config) {
...
function commentOutFlipper(mainApplication) {
  if (
    mainApplication.match(/\s+ReactNativeFlipper.initializeFlipper\(/m) === null
  ) {
